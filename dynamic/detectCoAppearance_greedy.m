...
%
%  This version differs from the original detectCoAppearance.m in the use
%  of a different criterion for co-appearance: any up-step in prey intensity 
%  coincinding with bait appearance is counted as a co-appearance event, 
%  regardless of whether it's the first up-step in the prey channel.
%
