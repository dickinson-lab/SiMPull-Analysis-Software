function plotTraces(dynData,index)
figure
...
hold on
plot(greenStart:greenStart+greenLength-1,dynData.FarRedSpotData(index).intensityTrace(greenStart:greenStart+greenLength-1),'m');
end
