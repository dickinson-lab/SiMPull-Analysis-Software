...
%     end
    ...
    figure(dBplot); hold on; plot(dBDensity(1:length(pctCoApp)),pctCoApp,marker,'MarkerSize',2.5,'Color',colors(f,:),'DisplayName',fileName); hold off
    figure(dPplot); hold on; plot(dPDensity(1:length(pctCoApp)),pctCoApp,marker,'MarkerSize',2.5,'Color',colors(f,:),'DisplayName',fileName); hold off
    figure(aBplot); hold on; plot(aBDensity(1:length(pctCoApp)),pctCoApp,marker,'MarkerSize',2.5,'Color',colors(f,:),'DisplayName',fileName); hold off
    figure(aPplot); hold on; plot(aPDensity(1:length(pctCoApp)),pctCoApp,marker,'MarkerSize',2.5,'Color',colors(f,:),'DisplayName',fileName); hold off
