                    ...
                    if gridData(b).([thisChannel 'SpotCount']) > 0  
                        ...
                        for a = 1:gridData(b).([testChannel 'SpotCount'])
                            ...
                            if ~isempty(match)
                                ...
                                gridData(b).([testChannel thisChannel 'ColocSpotData'])(colocResults.([testChannel thisChannel 'ColocSpots'])).([thisChannel 'SpotLocation']) = gridData(b).([thisChannel 'SpotData'])(match).spotLocation;
                                gridData(b).([testChannel thisChannel 'ColocSpotData'])(colocResults.([testChannel thisChannel 'ColocSpots'])).([thisChannel 'IntensityTrace']) = gridData(b).([thisChannel 'SpotData'])(match).intensityTrace;
                                try gridData(b).([testChannel thisChannel 'ColocSpotData'])(colocResults.([testChannel thisChannel 'ColocSpots'])).([thisChannel 'NSteps']) = gridData(b).([thisChannel 'SpotData'])(match).nSteps; end
                                try gridData(b).([testChannel thisChannel 'ColocSpotData'])(colocResults.([testChannel thisChannel 'ColocSpots'])).([thisChannel 'Changepoints']) = gridData(b).([thisChannel 'SpotData'])(match).changepoints; end
                                try gridData(b).([testChannel thisChannel 'ColocSpotData'])(colocResults.([testChannel thisChannel 'ColocSpots'])).([thisChannel 'Steplevels']) = gridData(b).([thisChannel 'SpotData'])(match).steplevels; end
                                gridData(b).([testChannel thisChannel 'ColocSpotData'])(colocResults.([testChannel thisChannel 'ColocSpots'])).([testChannel 'SpotLocation']) = gridData(b).([testChannel 'SpotData'])(a).spotLocation;
                                gridData(b).([testChannel thisChannel 'ColocSpotData'])(colocResults.([testChannel thisChannel 'ColocSpots'])).([testChannel 'IntensityTrace']) = gridData(b).([testChannel 'SpotData'])(a).intensityTrace;
                                try gridData(b).([testChannel thisChannel 'ColocSpotData'])(colocResults.([testChannel thisChannel 'ColocSpots'])).([testChannel 'NSteps']) = gridData(b).([testChannel 'SpotData'])(a).nSteps; end
                                try gridData(b).([testChannel thisChannel 'ColocSpotData'])(colocResults.([testChannel thisChannel 'ColocSpots'])).([testChannel 'Changepoints']) = gridData(b).([testChannel 'SpotData'])(a).changepoints; end
                                try gridData(b).([testChannel thisChannel 'ColocSpotData'])(colocResults.([testChannel thisChannel 'ColocSpots'])).([testChannel 'Steplevels']) = gridData(b).([testChannel 'SpotData'])(a).steplevels; end
                            else
